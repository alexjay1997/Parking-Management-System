            ...
            <div class="col-md-10 dash justify-content-center">
                <div class="container"><br>
                    ...
                    <div class="row d-flex justify-content-center">
                        <a href="#" class="add-employee-box col-md-6 " data-toggle="modal" data-target="#myModal" style="text-decoration:none;" >
                        <div >
                        <h1 class="fas fa-user">+ </h1>
                        <h4>Add employees</h4>
                        </div>
                        </a>
                        <a href="view_employee.php" class="view-employee-box col-md-6" style="text-decoration:none;">
                        <div >
