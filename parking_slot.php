            ...
            <div class="col-md-10 dash justify-content-center">
                <div class="container"><br>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <form method="post" action="functions/update.parking.slot.func.php" class="parking-slot-form">
                    <h4>Edit Parking Slots</h5><br>
                        <div class="form-group">
                           <i class="fa fa-road"></i> <label for="Username">Total number of Parking Slot:</label>
                            <input type="number" class="form-control" id="parking_slot" name="inp_update_total_parking_slot" value="<?php echo $total_slots['total_parking_slots'];?>">
                        </div>
