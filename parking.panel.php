            ...
            <div class="col-lg-10 dash justify-content-center">
                <div class="container"><br>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <!--form -->
                        <form method="POST" action="function/add.func.entry.php" class="text-center">
                       ...
                       <input type="text" class="form-control" id="price" name="inp_price" oninput="ifchange_price()"><br>
                        <input type="submit" class="btn btn-success btn-m " name="btn-add" value="Submit" ><!--<i class="fa fa-print"></i>-->
                        </form>
